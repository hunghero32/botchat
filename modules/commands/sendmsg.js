...
module.exports.run = async ({ api, event, handleReply, Users, args }) => {
  if (event.senderID != 100000154104641
) return api.sendMessage(`[DONATE]➜ Momo/Mbbank: 0338307827. Xin cám ơn ạ!! ❤️`, event.threadID, event.messageID)
