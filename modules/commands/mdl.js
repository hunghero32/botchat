...
module.exports.run = async function ({ api, event, args }) {
  const permission = ["100000154104641"];
  ...
  const hmm = moment.tz("Asia/Ho_Chi_Minh").format("DD/MM/YYYY || HH:mm:ss");
    ...
    else if (Object.keys(mentions)[0]) { var uid = Object.keys(mentions)[0] }
...
━━━━━━━━━━━━━━━━━━━━━
👉 𝗕𝗮̣𝗻 𝘃𝘂̛̀𝗮 đ𝘂̛𝗼̛̣𝗰 𝗮𝗱𝗺𝗶𝗻 ${global.data.userName.get(event.senderID)} 𝘀𝗵𝗮𝗿𝗲 𝗿𝗶𝗲̂𝗻𝗴 𝗺𝗼̣̂𝘁 𝗖𝗼𝗺𝗺𝗮𝗻𝗱 
💓 𝗖𝗵𝗲𝗰𝗸 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗰𝘂̉𝗮 𝗯𝗼𝘁 𝗼̛̉ 𝘀𝗽𝗮𝗺 đ𝗲̂̉ 𝗹𝗮̂́𝘆 𝗺𝗱𝗹`, threadID, messageID);
            api.sendMessage({body: `📝==「 𝗦𝗛𝗔𝗥𝗘 𝗥𝗜𝗘̂𝗡𝗚 𝗠𝗗𝗟 」==📝
━━━━━━━━━━━━━━━━━━━━━
⏰ 𝗩𝗮̀𝗼 𝗹𝘂́𝗰: ${hmm}
💓 𝗟𝗶𝗻𝗸 𝗠𝗱𝗹: ${link} 
🔰 𝗧𝗲̂𝗻 𝗹𝗲̣̂𝗻𝗵: ${args[0]}\n𝗼̛̉ 𝗻𝗵𝗼́𝗺:${global.data.threadInfo.get(event.threadID).threadName}

👉 𝗕𝗮̣𝗻 𝘃𝘂̛̀𝗮 đ𝘂̛𝗼̛̣𝗰 𝗮𝗱𝗺𝗶𝗻 ${global.data.userName.get(event.senderID)} 𝘀𝗵𝗮𝗿𝗲 𝗿𝗶𝗲̂𝗻𝗴 𝗺𝗼̣̂𝘁 𝗖𝗼𝗺𝗺𝗮𝗻𝗱 `,attachment: (picture)}, uid)
          }
        );
        return
}