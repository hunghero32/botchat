...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`梁Admin Bot梁\n
👀 Tên: Hưng
💮 Biệt danh: Hưng Việt Nguyễn
❎ Tuổi: 18+
👤 Giới tính: Nam
💫 Chiều cao cân nặng: 1m7 x 50kg
💘 Mối quan hệ: éo có ny
🌎 Quê quán: 88 Vĩnh Phúc
👫 Gu: Dú bự :>>
🌸 Tính cách: Lúc vui lúc buồn
🌀 Sở thích: Chơi game, xem phim anime blabla, ăn, ngủ
💻Contact💻
☎ SĐT&Zalo:0338.307.827
🤧Facebook:https://www.facebook.com/hunghero32
✉️ Email: hung87800@gmail.com :>`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100014233271071}/picture?height=720&width=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(
